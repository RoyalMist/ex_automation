defmodule ExAutomationWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ExAutomationWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ExAutomationWeb.Gettext, "errors", msg, opts)
    end
  end
